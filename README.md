# Viselitsa
Игра "Виселица" на Windows Forms C#

# Правила игры
Компьютер загадывает слово — пишет на экране некоторые буквы слова и отмечает места для остальных букв. Также рисуется виселица с петлёй.
